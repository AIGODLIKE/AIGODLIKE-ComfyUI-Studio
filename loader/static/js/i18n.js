  ...
  en: {
    ...
    settings: {
      ...
      modelShield: {
        ...
        describe:
          "You can decide that some models are no longer displayed and thumbnail rendered in specific loaders (this is only useful for supported loaders)",
        loaderName: "Loader Name",
        shieldingModel: "Shielding model",
        blockInputBoxText:
          "The complete name of the blocked model file(such as a.ckpt)",
        confirmText: "Confirm",
        cancelText: "Cancel",
      },
    },
